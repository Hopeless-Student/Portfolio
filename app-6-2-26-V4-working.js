  ...
  */
      ...
      function checkEmpNum(showError = true) {
          ...
          const isEmpNumValid = /^\d{6}$/.test(empNum);
      		// console.log(isEmpNumValid);
      		// console.log(typeof(empNum));
          // const text = "Fastball - Live Call Monitoring"
          // console.log(text.includes("Fastball"));
          if (!isEmpNumValid) {
              if (showError) {
              ...
              toggleFields(true);
              return false;
          } else if(empNum < "13000"){
              if (showError) {
                error.textContent = "Employee number must start at 13000.";
              }
              toggleFields(true);
              return false;
          }
      ...
      function setupCharCounter(textareaId, counterId, errorId) {
          ...
          textarea.addEventListener('keyup', () => {
              ...
              if(currentLength <= min){
                error.textContent = "Please provide a statement greater than 20 characters."
              }  else {
                  error.textContent="";
                }
      ...
      setupCharCounter('desc','descMaxCharCount', 'descError');
      setupCharCounter('promise','empMaxCharCount', 'promiseError');
      setupCharCounter('supervisor','svMaxCharCount', 'supervisorActionError');
      ...
      async function generatePDF() {
          ...
          pdf.save(`${data.name}_${data.coaching_type}.pdf`);
      }
      ...
      if (!isValid(data)) {
          ...
          downloadFile(sql, `${data.name}_${data.coaching_type}.txt`);
          return true;
      }
